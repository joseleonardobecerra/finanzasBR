// --- MAIN APP ---
    function App() {
      ...
      // ============================================================================
      // 🔥 ESTADO LOCAL — solo lectura, Firestore escribe via onSnapshot
      // ============================================================================
      ...
      // ── Contador de colecciones cargadas (reemplaza el setTimeout) ─────────────
      ...
      // ============================================================================
      // ✏️  API DE ESCRITURA ATÓMICA — una op = una escritura en Firestore
      // ============================================================================
      ...
      const fire = {
        ...
        /** Importación masiva: borra todo y reescribe en lotes de 450 */
      ...
      // ── Simulador agrega pago fijo ──────────────────────────────────────────────
      const addPagoFijoToState = (pf) =>
        addPagoFijo({ ...pf, id: generateId(), diaPago: pf.diaPago || 1, categoria: pf.categoria || 'Otros' });
      ...
      // ============================================================================
      // 📊  calculatedAccounts — recalcula saldos desde cero
      //     (candidato futuro a desnormalizar en Firestore)
      // ============================================================================
        ...
        <div className="min-h-screen bg-[#0f0f11] text-slate-200 flex flex-col md:flex-row font-sans pt-[24px]">
          ...
          {isOffline && (
            <div className="fixed top-0 left-0 right-0 bg-amber-600 text-white text-[11px] font-bold text-center py-1 z-[100] flex justify-center items-center gap-2 shadow-md">
              <AlertCircle size={14} /> Sin conexión. Trabajando offline (Los cambios se guardarán solos al reconectar).
            </div>
          )}
