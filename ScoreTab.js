const ScoreTab = ({ scoreData, scoreHistory, selectedMonth, presupuestos, egresosMes, cuentas, ingresosMesTotal, egresosMesTotal, cuotasMesTotal, pagosFijos }) => {
      ...
      // FIX: pagosFijos ya llega filtrado desde App.js (activePagosFijos).
      // La suma representa la META MENSUAL total de inversión/ahorro programada.
      // No hay que filtrar por mes adicional porque los pagosFijos son recurrentes mensuales.
